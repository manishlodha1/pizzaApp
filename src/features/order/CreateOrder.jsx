...
import { fetchAddress, getUserState } from "../user/userSlice";
...
export const action = async ({ request })=>
{
  ...
  {
    errors.phone = "Please give your correct phone number. We might need it to contact you."
  }
...
const CreateOrder = ()=> 
{
  ...
  const { username, status: addressStatus, position , address, error: errorAddress} = useSelector(getUserState);
    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center relative">
          ...
          {!position?.longitude && !position?.latitude && (<span className="absolute right-[3px] top-[3px] md:right-[5px] md:top-[5px] z-50"><Button disabled={isLoadingAddress} type="small" onClick={handleFetchAddress}>Get position</Button></span>) }
        </div>
